...
public class SQLConstants {
    ...
    public static final String AUDIT_RATES_TABLE                = "INSERT INTO " + Constants.SQLiteDatabase.TABLE_GOLD_RATES_AUDIT + " SELECT * FROM " + Constants.SQLiteDatabase.TABLE_GOLD_RATES + " WHERE " + Constants.SQLiteDatabase.GOLD_RATES_BANK_COLUMN + "= \"{0}\"";
    public static final String TRUNCATE_RATE_TABLE              = "DELETE FROM " + Constants.SQLiteDatabase.TABLE_GOLD_RATES + " WHERE " + Constants.SQLiteDatabase.GOLD_RATES_BANK_COLUMN + "= \"{0}\"";;
    public static final String INSERT_RATE                      = "INSERT INTO " + Constants.SQLiteDatabase.TABLE_GOLD_RATES + "(" +
            ...
            Constants.SQLiteDatabase.GOLD_RATES_TIMESTAMP_COLUMN +") VALUES ({0}, {1}, \"{2}\", \"{3}\")";
